...
st.image('Region_distribution.png', caption='', use_column_width=True)
...
st.image('salary_range.png', caption='', use_column_width=True)
...
st.image('opportunities.png', caption='', use_column_width=True)
...
st.image('gender_distribution.png', caption='', use_column_width=False, width=400)
